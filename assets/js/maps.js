...
document.getElementById("btn-skye-activities").addEventListener("click", () => {
    ...
    `
        },
        {
            ...
            contents: `<h5 class = "marker-head">Skye High Wildlife<span class = "marker-image">
        <img src="assets/images/marker-images/skye-activity/Skye-Wildlife.jpg"  alt = "Skye High Wildlife">
        </span></h5>
        <br>
        <div class = "info-website">Website: <a target = "_blank" href = "http://skyehighwildlife.com/">www.skyehighwildlife.com</a> </div>
        `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Skye Hikers<span class = "marker-image">
            <img src="assets/images/marker-images/skye-activity/Skye-Hikers.jpg"  alt = "Skye Hikers">
            </span></h5>
            <br>
            <div class = "info-website">Website: <a target = "_blank" href = "https://www.skyehikers.com/">www.skyehikers.com</a> </div>
            `
        },
        {
            coord: {
                lat: 57.62268,
                lng: -6.37712
            }, // White Wave Mountiain Boarding
            contents: `<h5 class = "marker-head">White Wave Mountiain Boarding<span class = "marker-image">
                <img src="assets/images/marker-images/skye-activity/Skye-Whitewave.jpg"  alt = "White Wave Mountiain Boarding">
                </span></h5>
                <br>
                <div class = "info-website">Website: <a target = "_blank" href = "https://www.white-wave.co.uk/activities/mountainboarding/">www.white-wave.co.uk</a> </div>
                `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Skye Photo Tours<span class = "marker-image">
                    <img src="assets/images/marker-images/skye-activity/Skye-Photos.jpg"  alt = "Skye Photo Tours">
                    </span></h5>
                    <br>
                    <div class = "info-website">Website: <a target = "_blank" href = "https://www.skyephototours.com/">www.skyephototours.com</a> </div>
                    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Scotland SUP Paddle Boarding<span class = "marker-image">
                        <img src="assets/images/marker-images/skye-activity/Skye-Sup.jpg"  alt = "Scotland SUP Paddle Boarding">
                        </span></h5>
                        <br>
                        <div class = "info-website">Website: <a target = "_blank" href = "https://www.scotlandsupco.com/">www.scotlandsupco.com</a> </div>
                        `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Skyefari<span class = "marker-image">
                            <img src="assets/images/marker-images/skye-activity/Skye-Skyefari.jpg"  alt = "Skyefari">
                            </span></h5>
                            <br>
                            <div class = "info-website">Website: <a target = "_blank" href = "https://www.skyefari.com/">www.skyefari.com</a> </div>
                            `
        },
        {
            coord: {
                lat: 57.30096,
                lng: -6.35242
            }, // Isle of Skye Boat Hire
            contents: `<h5 class = "marker-head">Isle of Skye Boat Hire<span class = "marker-image">
                                <img src="assets/images/marker-images/skye-activity/Skye-Boathire.jpg"  alt = "Isle of Skye Boat Hire">
                                </span></h5>
                                <br>
                                <div class = "info-website">Website: <a target = "_blank" href = "https://www.isleofskyeboathire.co.uk/index.html">www.isleofskyeboathire.co.uk</a> </div>
                                `
        }
    ];
...
document.getElementById("btn-skye-restaurants").addEventListener("click", () => {
    let skyeRestaurantLocations = [{
            ...
            contents: `<h5 class = "marker-head">Old School Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Oldschool.jpg"  alt = "Old School Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.oldschoolrestaurant.co.uk/">www.oldschoolrestaurant.co.uk</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Red Skye Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Redskye.jpg"  alt = "Red Skye Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "http://www.redskyerestaurant.co.uk/">www.redskyerestaurant.co.uk</a> </div>
    `
        },
        {
            coord: {
                lat: 57.44007,
                lng: -6.69566
            }, // Chidakasha Restaurant
            contents: `<h5 class = "marker-head">Chidakasha Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Chidakasha.jpg"  alt = "Chidakasha Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.chidakashaskye.co.uk/">www.chidakashaskye.co.uk</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Loch Bay Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Lochbay.jpg"  alt = "Loch Bay Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.lochbay-restaurant.co.uk/">www.lochbay-restaurant.co.uk</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Skye Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Isleskye.jpg"  alt = "Skye Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://restaurant-isleofskye.co.uk/">www.restaurant-isleofskye.co.uk</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Scorrybreac Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Scorrybreac.jpg"  alt = "Scorrybreac Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.scorrybreac.com/">www.scorrybreac.com</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">The Three Chimneys Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Threechimneys.jpg"  alt = "The Three Chimneys Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.threechimneys.co.uk/">www.threechimneys.co.uk</a> </div>
    `
        },
        {
            coord: {
                lat: 57.23911,
                lng: -5.89486
            }, // Deligasta Restaurant
            contents: `<h5 class = "marker-head">Deligasta Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Deligasta.jpg"  alt = "Deligasta Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.deligasta.co.uk/">www.deligasta.co.uk</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Sea Breezes Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Seabreeze.jpg"  alt = "Sea Breezes Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.squaremeal.co.uk/restaurants/sea-breezes-skye_18628">sea-breezes-skye</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">The Granary Restaurant<span class = "marker-image">
    <img src="assets/images/marker-images/skye-restaurant/Skye-Granary.jpg"  alt = "The Granary Restaurant">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "http://www.granary-skye.co.uk/">www.granary-skye.co.uk</a> </div>
    `
        }
    ];
...
document.getElementById("btn-skye-hotels").addEventListener("click", () => {
    let skyeHotelLocations = [{
            ...
            contents: `<h5 class = "marker-head">Sligachan Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Sligachan.jpg"  alt = "Sligachan Hotel">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "http://www.sligachan.co.uk/">www.sligachan.co.uk</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Marmalade Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Marmalade.jpg"  alt = "Marmalade Hotel">
    </span></h5>
    <br>
    ...
    `
        ...
        ,
        {
            ...
            contents: `<h5 class = "marker-head">Cullin Hills Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Cullinhills.jpg"  alt = "Cullin Hills Hotel">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.cuillinhills-hotel-skye.co.uk/">www.cuillinhills-hotel-skye.co.uk</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">The Bosville Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Bosville.jpg"  alt = "The Bosville Hotel">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://perlehotels.com/the-bosville/">www.perlehotels.com/the-bosville</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Skeabost Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Skeabost.jpg"  alt = "Skeabost Hotel">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://skyehotel.co.uk/skeabost/">www.skyehotel.co.uk/skeabost</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Eilean Iarmain Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Eilean.jpg"  alt = "Eilean Iarmain Hotel">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "http://eileaniarmain.co.uk/">www.eileaniarmain.co.uk</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Uig Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Uig.jpg"  alt = "Uig Hotel">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://www.uig-hotel-skye.com/">www.uig-hotel-skye.com</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">Greshornish Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Greshornish.jpg"  alt = "Greshornish Hotel">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://greshornishhouse.com/">www.greshornishhouse.com</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">The Skye Inn Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Skyeinn.jpg"  alt = "The Skye Inn Hotel">
    </span></h5>
    <br>
    <div class = "info-website">Website: <a target = "_blank" href = "https://theskyeinn.com/">www.theskyeinn.com</a> </div>
    `
        },
        {
            coord: {
            ...
            contents: `<h5 class = "marker-head">The Tongadale Hotel<span class = "marker-image">
    <img src="assets/images/marker-images/skye-hotels/Skye-Tongdale.jpg"  alt = "The Tongadale Hotel">
    </span></h5>
    <br>
